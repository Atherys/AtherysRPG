...
public class AtherysRPGConfig extends PluginConfig {
...

    {
        ...
        DAMAGE_CALCULATIONS.put(AtherysDamageTypes.PIERCE, "CLAMP(SOURCE_DEXTERITY - TARGET_DEFENSE, 1.0, 15.0)");
        DAMAGE_CALCULATIONS.put(AtherysDamageTypes.BALLISTIC, "CLAMP(SOURCE_DEXTERITY - TARGET_DEFENSE, 1.0, 15.0)");
    }
